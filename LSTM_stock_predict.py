# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 10:43:02 2019
...
#data = ts.get_hist_data(code = '002575',start = '2014-03-27', end = '2019-03-27')
...
def readData(column='high', n=30, all_too=True, index=False, train_end=-300):
    df = pd.read_csv(datapath + "Qunxingwanjv.csv", index_col=0)
